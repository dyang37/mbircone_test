...
def project(image, angles,
    ...
    Args:
        ...
        geometry (string, optional): This can be 'cone' or 'lamino'.
            If geometry=='cone', runs a standard cone-beam forward projection.
            If geometry=='lamino', runs a parallel-beam laminography forward projection, ignores dist_source_detector, magnification, row_offset, rotation_offset.
        theta (float, optional): Laminographic angle, equal to pi/2 - grazing angle. Ignored if geometry=='cone'.
